...
function ServicesDetail() {
    return ( 
        <div className='pt-20 pt-lg-45'>
            <div className='text-center fs-42 fs-lg-67 fw-bold mb-40 mb-lg-60'>creative kitchen</div>
            <div className="container">
                <div className={`row justify-content-between row-gap-20 mb-40 mb-lg-80`}>
                    <div className="col-md-6">
                        <Image src='/services/service3.jpg' width={560} height={560} alt="" className="img-fluid" />
